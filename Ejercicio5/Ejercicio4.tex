...
% =======================================================
    ...
    \def\ProjectNameLink{\ProjectAuthorLink/Analisis}                %Link to Proyect
        ...
        \ifthenelse{\isodd{\value{page}}}                           %IF ODD PAGE:
            ...
            {\href{https://compilandoconocimiento.com}              %ELSE DO THIS: 
                {\footnotesize                                      %Send the author
                    {\textsc{Ejercicio 4}}}}            %Send the author
    }
...
% =======================================================
    ...
    \lstdefinestyle{CompilandoStyle} {                              %This is Code Style
        backgroundcolor     = \color{Grey700},                %Background Color  
        basicstyle          = \tiny\color{white},                   %Style of text
        commentstyle        = \color{classicrose},                %Comment style
        stringstyle         = \color{amaranth},                   %String style
        keywordstyle        = \color{CyanClair300},                    %keywords style
        numberstyle         = \tiny\color{coralred},                  %Size of a number
...
\begin{titlepage}
    ...
    {\fontsize{36}{50}                                              %Size of the book
        \selectfont \textbf{Ejercicio 5}}\\[0.5cm]       %Name of the book
    {\fontsize{36}{50}                                              %Size of the book
        \selectfont \textbf{Divide y Vencerás}}\\[0.5cm]                %Name of the book
...
\subsection{Código}
\lstinputlisting[language=C++]{DV1B.cpp}
...
\subsection{Código}
\lstinputlisting[language=C++]{DV1.cpp}
...
de ellos, la complejidad temporal resulta ser $O(n^2)$. 
\subsection{Código}
\lstinputlisting[language=C++]{DV2B.cpp}
...
\subsection{Código}
\lstinputlisting[language=C++]{DV2.cpp}
...
de ellos, la complejidad temporal resulta ser $O(n^2)$. 
\subsection{Código}
\lstinputlisting[language=C++]{DV3B.cpp}
...
\subsection{Código}
\lstinputlisting[language=C++]{DV3.cpp}
